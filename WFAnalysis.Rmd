...
# Paramset Variables
MAfastPset  <- seq(10, 100, by = 10)        # fast moving average period for paramset
MAslowPset  <- seq(50, 300, by = 50)        # slow moving average period for paramset
MAmedPset  <- seq(30, 100, by = 10)         # slow moving average period for paramset
