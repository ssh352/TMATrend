...
This markdown document will generate a wlak forward analysis report for a symbol, it will test optimization via net trading PL and the ratio of profit to maximum draw down.
...
results <- walk.forward(strategy.st=strat, paramset.label='DMA_OPT', 
                        portfolio.st=portfolio.st,
                        account.st=account.st, period='years', k.training=5,
                        k.testing=1, nsamples=0, 
...
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.",symbol,".2006*.2010*.RData", sep = ""))))
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.",symbol,".2007*.2011*.RData", sep = ""))))
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.",symbol,".2008*.2012*.RData", sep = ""))))
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.",symbol,".2009*.2013*.RData", sep = ""))))
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.",symbol,".2010*.2014*.RData", sep = ""))))
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.",symbol,".2011*.2015*.RData", sep = ""))))
...
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.p2d.",symbol,".2006*.2010*.RData", sep = ""))))
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.p2d.",symbol,".2007*.2011*.RData", sep = ""))))
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.p2d.",symbol,".2008*.2012*.RData", sep = ""))))
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.p2d.",symbol,".2009*.2013*.RData", sep = ""))))
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.p2d.",symbol,".2010*.2014*.RData", sep = ""))))
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.p2d.",symbol,".2011*.2015*.RData", sep = ""))))
...
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.anc.",symbol,".2006*.2010*.RData", sep = ""))))
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.anc.",symbol,".2006*.2011*.RData", sep = ""))))
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.anc.",symbol,".2006*.2012*.RData", sep = ""))))
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.anc.",symbol,".2006*.2013*.RData", sep = ""))))
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.anc.",symbol,".2006*.2014*.RData", sep = ""))))
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.anc.",symbol,".2006*.2015*.RData", sep = ""))))
...
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.p2danc.",symbol,".2006*.2010*.RData", sep = ""))))
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.p2danc.",symbol,".2006*.2011*.RData", sep = ""))))
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.p2danc.",symbol,".2006*.2012*.RData", sep = ""))))
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.p2danc.",symbol,".2006*.2013*.RData", sep = ""))))
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.p2danc.",symbol,".2006*.2014*.RData", sep = ""))))
chartForwardTraining(list.files(pattern=glob2rx(paste("wfa.p2danc.",symbol,".2006*.2015*.RData", sep = ""))))
